...
if (isset($_POST['edit'])) {
    ...
    if (isset($_FILES['product_image']['name']) && $_FILES['product_image']['name'] != '') {
        $fileName = time() . '_' . basename($_FILES['product_image']['name']);
        move_uploaded_file($_FILES['product_image']['tmp_name'], __DIR__ . '/../assets/uploads/' . $fileName);
        $oldImage = __DIR__ . '/../assets/uploads/' . $edit['product_image'];
        if (!empty($edit['product_image']) && file_exists($oldImage)) {
            unlink($oldImage);
        }
        $product_image = $fileName;
    }
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <img src="assets/uploads/<?= isset($_GET['edit']) ? $edit['product_image'] : ''; ?>"
                                width="100">
                        </div>
